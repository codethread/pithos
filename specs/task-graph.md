...
- `packages/pithos/src/engine.ts` and `packages/pithos/src/engine/*` — state transitions, Task/Scope read models, graph inspection, Engine output contracts, and text renderers
