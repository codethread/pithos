...
| [agent-command-reference.md](./agent-command-reference.md)       | Defines implemented agent-oriented Markdown command references generated from CLI metadata                          | `packages/spawner/src/`, `templates/`, `packages/pithos/src/cli.ts`, `packages/pdx/src/main.ts`         |
