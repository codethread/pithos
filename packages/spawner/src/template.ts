...
export const loadAgentManifests = (agentsPath: string): readonly AgentManifest[] =>
	loadAgentsFile(agentsPath).agents;
...
export const loadTemplate = (
	...
	const launcher =
		manifest.launcher === undefined ? undefined : agentsFile.launchers[manifest.launcher];
	return {
		manifest,
		launcher,
		body: readTemplateFile(join(templatesDir, manifest.system_prompt)),
		includes,
	};
};
